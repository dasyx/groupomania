        ...
        <div class="post_comments">
          <ul v-if="comments.length">
            ...
            >
              ...
              <span class="post_comments-display">
                {{ comment.User.username }}&ensp;</span
              >
              :&ensp;{{ comment.content }}
              <a
                v-if="comment.UserId == userLoggedId"
                class="post_delete-btn"
...
export default {
  ...
  methods: {
    ...
    async getPostElements() {
      this.userLoggedId = sessionStorage.getItem("user-id");
      const options = {
        headers: {
