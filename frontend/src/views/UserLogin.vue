    ...
    <div class="field">
      ...
      <div v-if="submitted && $v.userForm.email.$error">
        <span v-if="!$v.userForm.email.required"
          ><i class="fas fa-exclamation-triangle bg"
    ...
    <div class="field">
      ...
      >
        <span v-if="!$v.userForm.password.required"
          ...
          ></span
        >
        <span v-if="!$v.userForm.password.password"
          ><i class="fas fa-exclamation-triangle bg"
...
export default {
  ...
  methods: {
    logValid() {
      ...
      if (this.$v.$invalid) {
        console.log(
          "Adresse email non reconnue ou mot de passe non valide, veuillez recommencer la saisie !"
        );
      } else {
