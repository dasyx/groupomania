    ...
    <form @submit.prevent="logValid" class="form">
        ...
        <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
                <input class="input" type="email" v-model="userForm.email" v-on:input="emailValidInput" id="email" name="email" placeholder="Veuillez saisir votre adresse email" value="" />
        ...
        <div class="field">
            ...
            <div class="control has-icons-left has-icons-right">
                <input class="input" type="password" v-model="userForm.password" id="password" name="password" placeholder="Veuillez saisir votre mot de passe" value="" />
                <span class="icon is-small is-left">
